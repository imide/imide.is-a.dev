...
### Configuration Via A Functional Languauge Is Dumb.
...
### Why not use some other language spcifically for configuration?
...
Yea that's just it, if I find someone doing any other dumb arguement, I will add it here. For Now, Goodbye!
